...
-- MAGIC %scala 
-- MAGIC
-- MAGIC val athlete_events = sqlContext.read.format("csv") /*#reading csv file */
-- MAGIC   .option("header", "true")  /* reading column names */ 
-- MAGIC   .option("inferSchema", "true") /* automatically inherit the datatype of the attributes */ 
-- MAGIC   .load("/FileStore/tables/athlete_events.csv") /* load will uplaod the location of the file */
-- MAGIC
...
-- MAGIC %scala
-- MAGIC
-- MAGIC athlete_events.printSchema /* this will print schema of the CSV file */
...
-- MAGIC %scala
-- MAGIC /* Creating temporary view for select statements  */
